...
# rand함수 : uniform distribution, 0 <= n < 1
...
# print(np.random.randn(5, 5))  # 25개의 원소가 랜덤하게 생성 (평균 0이고 표준편차는 1.0)

# 25개의 원소가 랜덤하게 생성 (평균 10이고 표준편차는 2.0)
# mean + standard_deviation * np.random.randn(, )
mean = 10
